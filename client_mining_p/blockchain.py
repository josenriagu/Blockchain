...
class Blockchain(object):
    ...
    def hash(self, block):
        ...
        hashed_block_string = hashlib.sha256(block_string).hexdigest()
    ...
    def valid_proof(block_string, proof):
        ...
        """
        # TODO
        # set a initial guess: concatenate block string and proof then encode them
...
def home():
    response = "Hey you, welcome to the UltimateMiner"
